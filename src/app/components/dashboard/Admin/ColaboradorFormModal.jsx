// src/app/components/dashboard/Admin/ColaboradorFormModal.jsx (Ensure unique and necessary code)
...
const ColaboradorFormModal = ({ isOpen, onClose, refreshList }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post('/api/colaborador/create', formData, {
        headers: {
        ...
        <ModalBody>
          <Stack spacing={4}>
            ...
            <FormControl isRequired>
              ...
              <Input type="password" name="col_password" value={formData.col_password} onChange={handleInputChange} />
            </FormControl>
          </Stack>
        </ModalBody>
        <ModalFooter>
