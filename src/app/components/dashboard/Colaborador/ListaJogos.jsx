...
import {
  ...
  Radio, FormControl, FormLabel, Input, Stack, Container, Select
    ...
    <Container maxW="container.xl" py={6}>
      <VStack spacing={6} align="stretch">
        <HStack justify="space-between">
          <Heading as="h3" size="lg" color="green.700">Lista de Salas/Jogos</Heading>
          <Button 
            leftIcon={<FaHistory />}
